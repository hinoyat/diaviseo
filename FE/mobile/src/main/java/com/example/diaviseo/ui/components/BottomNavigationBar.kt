        ...
        Surface(
            ...
            NavigationBar(
                ...
                NavigationBarItem(
                    icon = {
                        Icon(
                            painter = painterResource(id = R.drawable.bottom_dashboard),
                    ...
                    selected = true, // 현재 선택된 탭 여부 (테스트용으로 true 처리중)
                ...
                NavigationBarItem(
                    icon = {
                        Icon(
                            painterResource(id = R.drawable.bottom_chat), contentDescription = "챗봇",
                            modifier = Modifier.size(28.dp),
                            tint = Color.Unspecified
                        )
                    },
                ...
                NavigationBarItem(
                    icon = {
                        Icon(
                            painterResource(id = R.drawable.bottom_goal), contentDescription = "목표",
                            modifier = Modifier.size(28.dp),
                            tint = Color.Unspecified
                        )
                    },
                ...
                NavigationBarItem(
                    icon = {
                        Icon(
                            painterResource(id = R.drawable.bottom_my), contentDescription = "마이",
                            modifier = Modifier.size(28.dp),
                            tint = Color.Unspecified
                        )
                    },
