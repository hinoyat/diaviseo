...
SSAFY에서의 마지막 프로젝트를 감사하게도 좋은 기회로 디아비전이라는 기업과 연계하여 진행할 수 있어서 정말 뜻 깊은 시간이었습니다. 기업이 요구하는 요구사항을 최대한 반영하려고 노력하는 과정에서 사용자 관점에서의 개발이 무엇인지 깨닫게 되는 계기가 되었던 것 같습니다. 제가 맡은 인프라 업무에서도 사용자가 서비스를 이용할 때 서비스의 끊김 현상이나 대량의 트래픽이 몰렸을 때 서버가 다운되는 상황을 방지하기 위해서 Kubernetes를 도입하여 HPA를 통해 트래픽에 따라 서비스가 자동으로 확장이 되도록 하였고, 서비스가 다운이 되어도 자가 복구가 되도록 구성 하여 시스템 안정성에 큰 기여를 하였습니다. 이처럼 개발을 할 때 개발자 관점에서 벗어나 사용자 관점에서 어떠한 개발이 사용자에게 긍정적인 영향을 미칠지 생각하면서 개발할 수 있게 되었습니다.
